...
| 首页（殿堂） | 牌库（秘典） |
|--------------|--------------|
| ![首页截图](docs/home.png) | ![牌库截图](docs/cardList.png) |

| 占卜选择 | 抽牌界面 |
|----------|----------|
| ![牌阵选择](docs/divination_list.png) | ![轮盘抽牌](docs/divination_chioice.png) |

| 结果解读 | 历史记录 |
|----------|----------|
| ![解牌结果](docs/divination_result.png) | ![历史记录](docs/history.png) |

### 在线预览

（项目预览地址待补充，请在此处填入 Vercel/Netlify/GitHub Pages 等部署地址）
